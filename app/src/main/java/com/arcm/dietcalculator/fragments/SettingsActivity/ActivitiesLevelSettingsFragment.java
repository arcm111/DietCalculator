...
public class ActivitiesLevelSettingsFragment extends Fragment {
    public final static String TAG = "ActivitiesLevelSettingsFr";
    ...
    public ActivitiesLevelSettingsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_activities_level_settings, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // set listener after selecting the default checked radio button so
        // that the listener doesn't get triggered
        activityRadioGroup.setOnCheckedChangeListener(this::onRadioButtonChanged);
    ...
    private void onRadioButtonChanged(RadioGroup radioGroup, int i) {
